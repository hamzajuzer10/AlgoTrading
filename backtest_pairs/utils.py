...
def save_file_path(foldername:str, filename:str):
    """Outpyts the full filepath and creates the folder if doesnt exist"""

    cwd = os.getcwd()
    model_dir = os.path.join(cwd, foldername)
...
def create_dict(ticker=None, max_date=None, min_date=None, n_samples=None,
