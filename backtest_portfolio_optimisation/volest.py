...
from backtest_portfolio_optimisation import models
...
class VolatilityEstimator(object):
    ...
    def realized_vol(self, window=30):
        """Returns the realized volatility time series
    ...
    def benchmark_compare(self, window=90):
        ...
        # ensure both y and x have the same date ranges
    ...
    def term_sheet(
        ...
        fn = os.path.join(current_dir,'term-sheets', filename)
        pp = PdfPages(fn)
